...
import blogsFr from './contents/fr/blogsFr';

const productionUrl = {
  en: '/en',
  fr: '/fr'
};
const baseUrl = 'https://necraidan.com/blog';
...
module.exports = {
  ...
  head: {
    title: 'Benjamin Auzanneau | Builder and Re-Builder',
    meta: [
      { charset: 'utf-8' },
      ...
      { name: 'twitter:site', content: '@necraidan' },
  ...
  modules: ['@nuxtjs/style-resources', ['nuxt-i18n', I18N], 'nuxt-webfontloader'],

  styleResources: {
    scss: ['@/assets/css/utilities/_variables.scss', '@/assets/css/utilities/_helpers.scss', '@/assets/css/base/_grid.scss', '@/assets/css/base/_buttons.scss']
  },
  ...
  generate: {
    routes: ['/fr', '404'].concat(blogsEn.map(w => `/blog/${w}`)).concat(blogsFr.map(w => `fr/blog/${w}`))
  }
};
